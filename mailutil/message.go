...
func Send(testmode bool, msg *mail.Message, envelopeFrom string, envelopeTo []string) error {

	log.Println("[info] Sending email", `"`+TryMimeDecode(msg.Header.Get("Subject"))+`"`, "from", envelopeFrom, "to", len(envelopeTo), "recipient(s)")
